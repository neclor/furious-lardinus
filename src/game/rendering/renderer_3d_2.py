...
def get_tile_map_projections() -> list[tuple[pygame.Vector2, pygame.Surface, float]]:
	...
	#normalized_position = pygame.Vector2(position /
	...
	for _ in range(Settings.RAYS_NUMBER):
		...
		ray_local_ratio: pygame.Vector2 = pygame.Vector2(math.cos(ray_rotation) * Level.tile_size.x, math.sin(ray_rotation) * Level.tile_size.y)
